...
\begin{document}
    \begin{center}
        ...
        aggiornato al \emph{\textbf{Dicembre 2010}}
...
\ecvitem{\large\textbf{Impiego ricercato/ Settore di competenza}}{\large\textbf{Alla ricerca di una posizione in cui posso esprimere tutta la mia passione per la programmazione e la tecnologia. Programmo maggiormente in Python/Django usando quotidianamente Linux e OSX. Aperto a posizioni con possibilit\'a di crescita professionale e personale oltre che ben retribuite.}}

\ecvsection{Esperienza professionale}

\ecvitem{Date}{\textbf{Dal novembre 2010 a dicembre 2010}}
...
\ecvitem{Nome e indirizzo del datore di lavoro}{Exion Telecom - Via Cantonale 2b - 6928 Manno, Switzerland}
\ecvitem[10pt]{Tipo di attivit\'a o settore}{Soluzioni informatiche}

\ecvitem{Date}{\textbf{Da ottobre 2010 ad oggi}}
...
\ecvitem{Nome e indirizzo del datore di lavoro}{Sauce Labs Inc - 500 Third St., San Francisco, CA 94107 USA}
\ecvitem[10pt]{Tipo di attivit\'a o settore}{Cross Browser Testing in the Cloud}

\ecvitem{Date}{\textbf{Dal 26 aprile 2008 al 16 dicembre 2010}}
\ecvitem{Lavoro o posizione ricoperti}{Programmatore e sistemista nel reparto \textbf{''Ricerca e Sviluppo''} (apprendista part-time, 25 ore)}
...
Le tecnologie utilizzate sono per la maggiore Python/Django con database PostgreSQL su sitemi Debian virtualizzati su XEN.}
