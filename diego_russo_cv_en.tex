...
\cventry{2007-02/2007-07}{Radio-amateur \textbf{class A license}}{C.I.S.A.R. Foligno's section}{Assisi, IT}{PASSED, International Callsign \textbf{IZ0OVB}}{During the course for radio-amateur I acquired excellent knowledge of radio technology basics, radio devices and its usage and basics of Physics and Chemistry (magnetism, electromagnetism)}
...
\cvline{Languages}{Day-to-day: Python, Bash, Javascript, CSS/HTML, XML/JSON/YAML, SQL. Occasionally: LaTeX, Markdown, Java, Perl, C, Swift, Objective-C, Haskell, PHP, OCaml}
\cvline{Frameworks}{Day-to-day: Flask, AngularJS, Bootstrap. Occasionally: Django, CherryPy, JQuery, Nokia Qt4, Pylons}
\cvline{OSes}{Day-to-day: Linux (Debian based), Windows, macOS. Occasionally: *nix, XEN/KVM}
\cvline{IDEs}{Day-to-day: vim (I use it for everything!). Occasionally: Eclipse, XCode}
\cvline{Databases}{Day-to-day: MongoDB. Occasionally: PostgrSQL, Redis, MySQL, SQLite, CouchDB}
...
I was active as a contributor to the writing of the guide \url{http://www.ubuntusemplice.org/} (version 6.06 and 7.10, not active anymore). On this project I was the reviewer and author of several chapters, I administered the machine that hosts the site, wiki, blog and mailing list.\newline
\textbf{I also have a great passion for programming languages} knowing many of them. I studied LSL during my work on \textbf{Second Life}: in fact I have worked on many Italian metaverse project such as Assisi, Milan and Marostica on the \textbf{''Italia Vera''} project.\newline
I have a fair knowledge of graphic applications (Gimp, Photoshop) and office tools such as Openoffice.org and iWork (for OSX)\newline
