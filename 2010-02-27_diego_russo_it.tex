...
\renewcommand{\normalsize}{\fontsize{3.4mm}{4mm}\selectfont}
...
\ecvitem{Livello nella classificazione nazionale o internazionale}{Valutazioni\footnote{Valutazione in accordo con il ``Common European Framework of Reference for Languages''}:
\begin{itemize}
...
\ecvitem[10pt]{Capacit\`a e competenze tecniche ed informatiche}{\vspace{-2mm}
\begin{itemize}
