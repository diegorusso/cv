...
\extrainfo{ultimo aggiornamento: Novembre 2011} % optional, remove the line if not wanted
...
\cventry{2011/10--Current Position}{Sviluppatore Senior nel reparto IT}{ARM Ltd, \url{http://www.arm.com/}}{Cambridge}{}{Lavorando in team, sono responsabile dello sviluppo, miglioramento e correzione di errori dei software interni.}
...
\cventry{05/2012--06/2012}{Corso di Portoghese Brasiliano}{Sixth Form College}{Cambridge, UK}{\textbf{livello A2}}{Le competenze raggiunte sono tutte incluse nel \textbf{Quadro comune europeo di riferimento per la conoscenza delle lingue} (\url{http://it.wikipedia.org/wiki/Quadro_comune_europeo_di_riferimento_per_la_conoscenza_delle_lingue})}
