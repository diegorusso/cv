...
\extrainfo{last update: Novembre 2011} % optional, remove the line if not wanted
...
\cventry{2011/10--Current Position}{Senior Software Developer in IT Department}{ARM Ltd, \url{http://www.arm.com/}}{Cambridge}{}{Working in a team, I'm responsible of the development, improvement and bugfixing of internal softwares.}
...
\cventry{2012/05--2012/06}{Brazilian Portuguese Course}{Sixth Form College}{Cambridge, UK}{\textbf{A2 level}}{The skills achieved are all included in \textbf{Common European Framework of Reference for Languages} (\url{http://en.wikipedia.org/wiki/Common_European_Framework_of_Reference_for_Languages})}
