...
\address{Via G. Garibaldi, 40}{05021, Acquasparta (TR)}    % optional, remove the line if not wanted
...
\extrainfo{updated at March 2011} % optional, remove the line if not wanted
...
% \quote{smile :)}                 % optional, remove the line if not wanted
