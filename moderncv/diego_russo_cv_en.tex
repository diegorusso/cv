...
\address{8, Gerard Close, CB5 8NQ}{Cambridge (UK)}    % optional, remove the line if not wanted
...
\cvline{}{\large\textbf{I always look for a challenging position where I can express and use my passion for programming and technology. I mostly develop in Python in *NIX environment in a daily basis. As I'm a dynamic person, professional and personal growth are very important to me.}}
